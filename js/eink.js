...
(function () {
    ...
    // 第①档 轻：浅灰微压，最稳，黑字绝对安全
    //const CURVE = [0, 0.12, 0.23, 0.31, 0.39, 0.48, 0.60, 0.76, 1];
    // 第②档 中：当前脚本的加强版，对比明显
    //const CURVE = [0, 0.12, 0.22, 0.29, 0.36, 0.44, 0.55, 0.71, 1];
    // 第③档 重：浅色压得最狠，最黑，但头部依旧保黑字
    //const CURVE = [0, 0.11, 0.21, 0.27, 0.33, 0.40, 0.50, 0.66, 1];
